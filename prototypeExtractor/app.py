...
def crawl_site(root_url: str, max_depth: int, max_workers: int):
    ...
    # initial frontier (keyword-filter root expansion too)
    frontier = [root_url]
...
with col1:
    start_url = st.text_input("Website (start at a page likely to link to Help/FAQ):",value="https://www.aboutamazon.com")
...
if run:
    ...
    save_faqs_jsonl(faqs,"all_faqs.jsonl")
